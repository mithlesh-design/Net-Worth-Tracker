...
export function openingBuckets(plan) {
  ...
  return {
    ...
    /* Nothing feeds this yet; plan.properties arrives in the next commit. */
    property: 0,
  };
}
...
export function runProjectionV1(plan, opts) {
  ...
  for (let y = 0; y <= years; y++) {
    ...
    const availableCash = income - spends;
    ...
    const totalNW = liquidNW + lockedNW + illiquidNW - cumUnfunded;
    peakNW = Math.max(peakNW, totalNW);
